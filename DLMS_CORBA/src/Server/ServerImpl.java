...
public class ServerImpl extends ServerPOA {
	...
	public void RemoveFromBorrowList(String itemID) 
	{
...
{
	 response1 = borrowItem(userID, newItemId, false);
	System.out.println(response1);
	 response2 = returnItem(userID, oldItemId);
	System.out.println(response2);
}
result=response1!=""&&response2!=""?response1 +"\n"+response2:"Sorry,Cannot process the request currently.Please try again!!";
